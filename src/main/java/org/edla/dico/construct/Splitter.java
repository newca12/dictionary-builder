...
public class Splitter extends XMLFilterImpl {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts)
        ...
        System.out.println("test namespaceURI:"+namespaceURI);
        if( namespaceURI.equals("http://www.mediawiki.org/xml/export-0.3/") && localName.equals("page") ) {
            ...
            System.out.println("locator:"+locator.getLineNumber());
    ...
    public void endElement(String namespaceURI, String localName, String qName) throws SAXException {
        ...
        if( depth!=0 ) {
            ...
            if( depth==0 ) {
                ...
                try {
                    JAXBElement<PageType> result = 
			(JAXBElement<PageType>)unmarshallerHandler.getResult();
    ...
    public void process( PageType order ) {
