lazy val root = (project in file("."))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      Dependencies.akkaStreamAlpakkaFile,
      Dependencies.akkaStreamAlpakkaXml,
      Dependencies.apacheCommonCompress,
      Dependencies.akkaStreamContrib,
      Dependencies.akkaStreamCheckpointKamon,
      Dependencies.kamonStatd,
